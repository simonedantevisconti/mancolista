...
import { worldCup2026Series } from "../data/worldCup2026Cards";
...
const WorldCup2026CollectionDetail = () => {
  ...
  const totals = useMemo(() => {
    return worldCup2026Series.reduce(
      (result, series) => {
  ...
  return (
    <section className="collection-detail">
      <div className="page-heading">
        ...
        <h1>FIFA World Cup 2026 Panini</h1>
        <p>Scegli la raccolta che vuoi gestire e aggiorna mancanti e doppie.</p>
...
export default WorldCup2026CollectionDetail;
